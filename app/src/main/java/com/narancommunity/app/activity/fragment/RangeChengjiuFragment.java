...
/**
 * Writer：fancy on 2018/5/3 16:47
 * Email：120760202@qq.com
 * FileName :
 */

public class RangeChengjiuFragment extends Fragment {
    ...
    public static RangeChengjiuFragment newInstance() {

        RangeChengjiuFragment fragment = new RangeChengjiuFragment();
    ...
    private void getData() {
        ...
        NRClient.getChengjiuList(map, new ResultCallback<Result<GradeData>>() {
            @Override
...
//        recyclerView.addItemDecoration(dividerItemDecoration);
        ...
        adapter = new RangeListRangeAdapter(getContext(), listData, 2);
