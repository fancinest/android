...
public class RangeRangeFragment extends Fragment {
    ...
    private void getData() {
        ...
        NRClient.getRankList(map, new ResultCallback<Result<GradeData>>() {
            @Override
    ...
    private void setMyData(RankEntity myRank) {
        ...
        tvGrades.setVisibility(View.VISIBLE);
        rbStar.setVisibility(View.VISIBLE);
        tvGrades.setText(Utils.getValue(myRank.getRankName()) + "");
        rbStar.setRating(Utils.getValue(myRank.getRankScore()) / 2);
    ...
    private void setListView() {
        ...
        adapter = new RangeListRangeAdapter(getContext(), listData, 1);
