...
//import com.narancommunity.app.activity.index.book.MoreCommentAct;
...
// */
//
//public class BookYSHYCommentAdapter extends EasyRecyclerAdapter<CommentEntity> {
//    boolean isLimited = false;
//    CommentInterfaces meItemInterface;
//    int bookId = 0;
//    MeItemInterface clickLike;
//
//    public BookYSHYCommentAdapter(Context context, List<CommentEntity> list) {
//        super(context, list);
//    }
//
